...
function CompressData(const InData: Pointer; InSize: LongInt; out OutData: Pointer; out OutSize: LongInt) : LongInt;
function DecompressData(const InData: Pointer; InSize: LongInt; const OutData: Pointer; var OutSize: LongInt) : LongInt;
...
// в случае брутфорс сжатия нужно менять данные в WorkBuf
  ...
  Result := lzo_compress(InData^, InSize, OutData^, OutSize, WorkBuf);
end;

function DecompressData(const InData: Pointer; InSize: LongInt; const OutData: Pointer; var OutSize: LongInt) : LongInt;
begin
  Result := lzo_decompress(InData^, InSize, OutData^, OutSize);
end;
