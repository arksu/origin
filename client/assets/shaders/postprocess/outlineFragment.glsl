...
//    - unpack_depth(8 * texture2D(u_texture, v_texCoords2))
//    + unpack_depth(texture2D(u_texture, v_texCoords3))
//    + unpack_depth(texture2D(u_texture, v_texCoords4))
//    + unpack_depth(texture2D(u_texture, v_texCoords5))
//    + unpack_depth(texture2D(u_texture, v_texCoords6))
//    + unpack_depth(texture2D(u_texture, v_texCoords7))
//    + unpack_depth(texture2D(u_texture, v_texCoords8))
//    ) ;
