...
public class Render1 {
	private static final Logger _log = LoggerFactory.getLogger(Render1.class
			.getName());
	...
	public Render1(Game game) {
		...
		_model = loader.loadModel(Gdx.files
				.internal("assets/debug/invader.obj"));
		_model2 = loader
				.loadModel(Gdx.files.internal("assets/debug/block.obj"));
