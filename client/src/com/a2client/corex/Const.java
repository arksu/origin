...
public class Const
{
	...
	{
		utInt, utVec1, utVec2, utVec3, utVec4, utMat3, utMat4
	}

	public enum MATERIAL_SAMPLER
	{
		msDiffuse, msNormal, msSpecular, msAmbient, msEmission, msAlphaMask, msReflect, msShadow, msMask
...
//            put(MATERIAL_SAMPLER.msMap3, new SamplerIDObject(12, "sMap3"));
	...
	{
		maCoord, maBinormal, maNormal, maTexCoord0, maTexCoord1, maColor, maJoint
	}
	...
	{
		muModelMatrix, muLightMatrix, muViewPos, muJoint, muLightPos, muLightParam, muAmbient, muMaterial, muTexOffset,
		muFog
	}
	...
	{
		rtTexture, rtTexture1, rtTexture2, rtTexture3, rtTexture4, rtTexture5, rtTexture6, rtTexture7,
		rtTexture8, rtTexture9, rtTexture10, rtTexture11, rtTexture12, rtTexture13, rtTexture14,
		rtTexture15, rtShader, rtMeshIdex, rtMeshVertex, rtSound
	}

	public enum RENDER_MODE
	{
		rmOpaque, rmOpacity, rmShadow
	}
	...
	{
		rcDepth, rcColor0, rcColor1, rcColor2, rcColor3, rcColor4, rcColor5, rcColor6, rcColor7
	}

	public enum TEXTURE_TARGET
	{
		ttTex2D, ttTexCubeXp, ttTexCubeXn, ttTexCubeYp, ttTexCubeYn, ttTexCubeZp, ttTexCubeZn
	}

	public enum BLEND_TYPE
	{
		btNone, btNormal, btAdd, btMult
	}

	public enum CULL_FACE
	{
		cfNone, cfFront, cfBack
	}
