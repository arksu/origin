...
public class Mat4f
{
    public float e00, e10, e20, e30, e01, e11, e21, e31, e02, e12, e22, e32, e03, e13, e23, e33;
    ...
    {
        return new Vec3f(e00 * v.x + e01 * v.y + e02 * v.z + e03, e10 * v.x + e11 * v.y + e12 * v.z + e13,
                         e20 * v.x + e21 * v.y + e22 * v.z + e23);
    }

    public Vec4f mul(Vec4f v)
    {
        return new Vec4f(e00 * v.x + e01 * v.y + e02 * v.z + e03 * v.w, e10 * v.x + e11 * v.y + e12 * v.z + e13 * v.w,
                         e20 * v.x + e21 * v.y + e22 * v.z + e23 * v.w, e30 * v.x + e31 * v.y + e32 * v.z + e33 * v.w);
    }
    ...
    {
        float y = znear * (float) Math.tan(fov * 0.5 * Const.deg2rad);
        float x = y * aspect;
    ...
    public Quat getRot()
    {
        ...
        if (t > Const.EPS)
        {
            ...
            return new Quat((e21 - e12) * s, (e02 - e20) * s, (e10 - e01) * s, 0.25f / s);
        }
        else
        {
            if (e00 > e11 && e00 > e22)
            {
                ...
                return new Quat(0.25f * s, (e01 + e10) / s, (e02 + e20) / s, (e21 - e12) / s);
            }
            else
            {
                if (e11 > e22)
                {
                    ...
                    return new Quat((e01 + e10) / s, 0.25f * s, (e12 + e21) / s, (e02 - e20) / s);
                }
                else
                {
                    float s = (float) (2 * Math.sqrt(1 + e22 - e00 - e11));
                    return new Quat((e02 + e20) / s, (e12 + e21) / s, 0.25f * s, (e10 - e01) / s);
                }
            }
        }
    }

    public Mat4f setRot(Quat q)
    {
