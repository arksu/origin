...
import com.a4server.gameserver.network.packets.serverpackets.Init;
...
public class GameServerHandler extends SimpleChannelInboundHandler<byte[]>
{
	...
	public GameServerHandler(AsyncPacketReader<GamePktClient> reader)
	{
		super();
		_reader = reader;
	}
