...
import com.a4server.gameserver.network.packets.serverpackets.CharSelected;
...
public class CharacterSelect extends GameClientPacket
{
	...
	public void run()
	{
		final GamePktClient client = getClient();
			...
			try
			{
				...
				if (client.getActiveChar() == null)
				{
					...
					if (World.getInstance().addPlayer(cha))
					{
						...
						client.setState(GamePktClient.GameClientState.IN_GAME);
					}
				}
			}
			finally
