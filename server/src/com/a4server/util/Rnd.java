...
public final class Rnd
{
    ...
    protected static final class RandomContainer
    {
         ...
         * @see com.a4server.util.Rnd#nextDouble()
         */
    ...
    public static enum RandomType
    {
        ...
        /**
         * Like {@link com.a4server.util.Rnd.RandomType#UNSECURE_ATOMIC}.<br>
         * Each thread has it`s own random instance.<br>
         * Provides best parallel access speed.
         *
         * @see com.a4server.util.Rnd.ThreadLocalRandom
         */
         ...
         *
         * @see com.a4server.util.Rnd.NonAtomicRandom
         */
        UNSECURE_VOLATILE
    }
