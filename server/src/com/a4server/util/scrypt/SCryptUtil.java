package com.a4server.util.scrypt;

import java.io.UnsupportedEncodingException;
import java.security.GeneralSecurityException;
import java.security.SecureRandom;

import static com.a4server.util.scrypt.Base64.decode;
import static com.a4server.util.scrypt.Base64.encode;
...
public class SCryptUtil
{
	...
	public static String scrypt(String passwd, int N, int r, int p)
	{
		try
		{
			...
			byte[] derived = SCrypt.scryptJ(passwd.getBytes("UTF-8"), salt, N, r, p, 32);
	...
	public static boolean check(String passwd, String hashed)
	{
		try
		{
			...
			byte[] derived1 = SCrypt.scryptJ(passwd.getBytes("UTF-8"), salt, N, r, p, 32);
